...
Judul: "Aplikasi Konversi Suhu" dengan ukuran font lebih besar dan tebal.

Label Input: Teks "Masukkan Suhu:" diikuti oleh kotak teks untuk pengguna memasukkan angka suhu yang ingin dikonversi.

Dropdown Pilihan Skala: Dropdown dengan label "Pilih" yang memungkinkan pengguna memilih skala suhu input (seperti Celcius, Fahrenheit, Reamur, atau Kelvin).

Pilihan Skala Tujuan: Terdapat empat tombol radio untuk memilih skala tujuan konversi:
Celcius
Reamur
Fahrenheit
Kelvin

Tombol Konversi: Sebuah tombol besar berlabel "Konversi" untuk memulai proses konversi suhu.
